...
class CategoryFullScreenViewModel(
    private val wallpaperByCategoryRepository: WallpaperRepository,
...
//    }
    ...
    suspend fun getWallpapersByCategory(category: String) {
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(
                ...
                return CategoryFullScreenViewModel(wallpaperRepository) as T
            }
        }
    }
}
